...
var TriggersDocs = React.createClass({
  render: function () {
    return (
      <div>
        <h2>Triggers</h2>
        <h4 className='subheader'>These are the set of components that trigger state change of components like modal, panel. Unique id of target components should be passed trigger attribute of these components</h4>
        <hr />
        <h3>Open</h3>
